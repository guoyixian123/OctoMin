...
![软件界面截图](print/截屏2026-06-29 21.28.40.png)
![软件界面截图](print/截屏2026-06-29 21.29.52.png)
## 特性

- ⚡ **多线程并行压缩/解压** - 充分利用多核 CPU，块级并行处理
- 🔒 **AES-256-GCM 加密** - 军用级加密保护你的文件
- 📦 **自定义 OMZ 格式** - 专为并行优化的压缩格式
- 🗂️ **支持多种格式** - 兼容 ZIP、RAR、7z、TAR、GZ、BZ2 等常见格式
- 🎯 **三种压缩算法** - LZ4（极速）、Zstandard（均衡）、LZMA（高压缩率）
- 🖥️ **原生 macOS 界面** - 简洁美观的 SwiftUI 图形界面
- 💻 **命令行工具** - 同时提供 CLI 版本，支持脚本自动化
- 🆓 **完全免费开源** - 所有功能无限制使用，包括多线程
